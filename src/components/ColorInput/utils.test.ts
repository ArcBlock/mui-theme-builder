...
describe('colorFromString tests', () => {
  ...
  test('rgb, rgba values return correctly', () => {
    ...
    expect(colorFromString('rgb(100.22,100.55,100.2)')).toBe('rgb(100.22,100.55,100.2)');
    expect(colorFromString('rgb(255,255,255,0.5)')).toBeNull();
    expect(colorFromString('rgba(255, 255, 255, 1)')).toBe('rgba(255, 255, 255, 1)');
    expect(colorFromString('rgba(100.22,100.55,100.2, 0.5)')).toBe('rgba(100.22,100.55,100.2, 0.5)');
  ...
  test('hsl,hsla values return correctly', () => {
    ...
    expect(colorFromString('hsla(360, 100%, 50%, 0.5)')).toBe('hsla(360, 100%, 50%, 0.5)');
